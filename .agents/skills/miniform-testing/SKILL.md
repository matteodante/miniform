...
Run `make test-stress` for high-volume submission, webhook, email, SQLite, or resource-lifecycle changes. Its SMTP capture is loopback-only, rejects recipients outside `.invalid`, and requires no external mail service.
