...
help:
	...
	@echo "  vendor       - download frontend dependencies (htmx and Tailwind)"
	...
	@echo "  test-stress  - stress HTTP, SQLite, webhook, SMTP, and resource lifecycles"
...
test-stress: deps
	...
	@echo ">> stressing core, webhook, and SMTP lifecycles ($(STRESS_REQUESTS) requests, concurrency $(STRESS_CONCURRENCY))"
