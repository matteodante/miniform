...
The current stable release is [`v0.1.0`](https://github.com/matteodante/miniform/releases/tag/v0.1.0). Pin an exact release or image digest in production; `main` remains the development branch.
...
```bash
docker pull ghcr.io/matteodante/miniform:v0.1.0
