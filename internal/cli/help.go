...
func commandManifest() []CommandSpec {
	commands := []CommandSpec{
		...
		{Name: "form create", Summary: "Create a form endpoint and its delivery policies.", Mutates: true, RequiresDatabase: true, Flags: []string{"--template STRING", "--name STRING", "--slug STRING", "--allowed-origins STRING", "--generated-html-file PATH", "--mailer-profile-id UINT", "--captcha-profile-id UINT", "--email-enabled", "--email-recipient STRING", "--webhook-enabled", "--webhook-url URL", "--webhook-secret-file PATH|-", "--webhook-headers-file PATH"}},
		{Name: "form update", Summary: "Update form and delivery settings; omitted flags preserve current values.", Mutates: true, RequiresDatabase: true, Flags: []string{"--id UINT", "--name STRING", "--slug STRING", "--allowed-origins STRING", "--generated-html-file PATH", "--clear-generated-html", "--mailer-profile-id UINT", "--clear-mailer-profile", "--captcha-profile-id UINT", "--clear-captcha-profile", "--email-enabled=BOOL", "--email-recipient STRING", "--webhook-enabled=BOOL", "--webhook-url URL", "--webhook-secret-file PATH|-", "--clear-webhook-secret", "--webhook-headers-file PATH", "--clear-webhook-headers"}},
